...
if __name__ == "__main__":
    ...
    with open(r"data\custom_aflw\annotations\face_landmarks_custom_aflw_test.json") as f:
        ann = json.load(f)
        
    image_dir = r"data/custom_aflw/images/" + ann['images'][0]['file_name']
    bbox = np.array([ann['annotations'][0]['bbox']])
    
    new_bbox = bbox_xywh2xyxy(bbox_xywh=bbox)
    print(new_bbox)