...
from mmpose.structures.bbox import bbox_xywh2cs, bbox_xywh2xyxy
from ..base import BaseCocoStyleDataset


@DATASETS.register_module()
class CustomAFLWDataset(BaseCocoStyleDataset):
    ...
    METAINFO: dict = dict(from_file='configs/_base_/datasets/custom_aflw.py')
